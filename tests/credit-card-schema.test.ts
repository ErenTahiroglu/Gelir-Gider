...
describe("credit-cards schema constants", () => {
	...
	it("CREDIT_CARD_STATEMENT_OPERATIONS contains CREATE, UPDATE, VOID", () => {
	...
	it("CREDIT_CARD_STATEMENT_STATUSES contains OPEN, VOID", () => {
		expect(CREDIT_CARD_STATEMENT_STATUSES).toContain("OPEN");
		expect(CREDIT_CARD_STATEMENT_STATUSES).toContain("VOID");
		expect(CREDIT_CARD_STATEMENT_STATUSES).not.toContain("PAID");
	});
